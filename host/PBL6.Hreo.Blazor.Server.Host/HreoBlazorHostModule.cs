...
using PBL6.Hreo.Blazor.Server.Host.Menus;
...
namespace PBL6.Hreo.Blazor.Server.Host
{
    [DependsOn(
        ...
        typeof(HreoBlazorServerModule)
    )]
    public class HreoBlazorHostModule: AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    typeof(HreoResource),
                    typeof(HreoDomainModule).Assembly,
                    typeof(HreoDomainSharedModule).Assembly,
                    typeof(HreoApplicationModule).Assembly,
                    typeof(HreoApplicationContractsModule).Assembly,
                    typeof(HreoBlazorHostModule).Assembly
                );
            });
        }
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            Configure<AbpBundlingOptions>(options =>
            {
                ...
                options.StyleBundles.Configure(
                    ...
                    bundle =>
                    {
                        ...
                        bundle.AddFiles("/PBL6.Hreo.Blazor.Server.Host.styles.css");
                    }
                );
            });
            ...
            if(hostingEnvironment.IsDevelopment())
            {
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<HreoBlazorHostModule>(hostingEnvironment.ContentRootPath);
                });
            }
            ...
            {
                options.AppAssembly = typeof(HreoBlazorHostModule).Assembly;
            });
        }
